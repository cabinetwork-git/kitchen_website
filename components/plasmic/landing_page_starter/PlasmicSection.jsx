...
import sty from "./PlasmicSection.module.css"; // plasmic-import: 0OUkU0_5vn08/css
  ...
  return (
    <div
      ...
      className={classNames(
        ...
        sty.root,
        {
          [sty.rootbackground__new]: hasVariant($state, "background", "_new"),
