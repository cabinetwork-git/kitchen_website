...
import Label from "../../Label"; // plasmic-import: _xM4MwCB6ZAd/component
import TextInput from "../../TextInput"; // plasmic-import: 5K_hpncPmsa5/component
import TextAreaInput from "../../TextAreaInput"; // plasmic-import: u7SYDNEWeVCB/component
import Description from "../../Description"; // plasmic-import: vOlX9TlVg4n5/component
import { _useStyleTokens } from "./PlasmicStyleTokensProvider"; // plasmic-import: oE3FNJgfJRWctRp1SvVjWz/styleTokensProvider
import "@plasmicapp/react-web/lib/plasmic.css";
import sty from "./PlasmicTextField.module.css"; // plasmic-import: -bjKjCKStmMX/css
...
function PlasmicTextField__RenderFunc(props) {
  ...
  return (
    ...
    >
      ...
      <div
        className={classNames("all", sty.freeBox___23WfR, {
          [sty.freeBoxiconEnd___23WfRWkOMf]: hasVariant(
            $state,
            "iconEnd",
            "iconEnd"
          ),
          [sty.freeBoxiconStart___23WfRaCPkx]: hasVariant(
            $state,
            "iconStart",
            "iconStart"
          ),
          [sty.freeBoxmultiLine___23WfRPfXyj]: hasVariant(
            $state,
            "multiLine",
            "multiLine"
          )
      ...
      >
        <div
          className={classNames("all", sty.freeBox__ty6Y, {
            [sty.freeBoxiconStart__ty6YACPkx]: hasVariant(
              $state,
              "iconStart",
              "iconStart"
            ),
            [sty.freeBoxmultiLine__ty6YPfXyj]: hasVariant(
              $state,
              "multiLine",
              "multiLine"
            )
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <CircleIcon
                className={classNames("all", sty.svg__gLpAx)}
                role={"img"}
              />
            ),
        ...
        <div
          className={classNames("all", sty.freeBox___5PyoG, {
            [sty.freeBoxiconEnd___5PyoGWkOMf]: hasVariant(
              $state,
              "iconEnd",
              "iconEnd"
            ),
            [sty.freeBoxiconStart___5PyoGaCPkx]: hasVariant(
              $state,
              "iconStart",
              "iconStart"
            )
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <CircleIcon
                className={classNames("all", sty.svg__dxN0K)}
                role={"img"}
              />
            ),
