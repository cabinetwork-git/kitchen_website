...
import sty from "./PlasmicButton.module.css"; // plasmic-import: hWiarQquCkSU/css
import CircleIcon from "./icons/PlasmicIcon__Circle"; // plasmic-import: FA6h8vgFP-0X/icon
import ChevronDownIcon from "./icons/PlasmicIcon__ChevronDown"; // plasmic-import: 9HFS9JmFDo0D/icon
...
function PlasmicButton__RenderFunc(props) {
  ...
  return (
    ...
    >
      ...
      <div
        className={classNames("all", sty.freeBox__oUgNi, {
          [sty.freeBoxcolor_neutral__oUgNimKXrd]: hasVariant(
            $state,
            "color",
            "neutral"
          ),
          [sty.freeBoxcolor_success_type_bordered__oUgNiYcBFwMUd6Q]:
            hasVariant($state, "color", "success") &&
            hasVariant($state, "type", "bordered"),
          [sty.freeBoxroundedFull__oUgNimcYlg]: hasVariant(
            $state,
            "roundedFull",
            "roundedFull"
          ),
          [sty.freeBoxsize_extraLarge__oUgNimIguE]: hasVariant(
            $state,
            "size",
            "extraLarge"
          ),
          [sty.freeBoxsize_extraSmall__oUgNi2OtO3]: hasVariant(
            $state,
            "size",
            "extraSmall"
          ),
          [sty.freeBoxsize_large__oUgNiF9TjD]: hasVariant(
            $state,
            "size",
            "large"
          ),
          [sty.freeBoxsize_small__oUgNiHj19N]: hasVariant(
            $state,
            "size",
            "small"
          ),
          [sty.freeBoxtype_bordered__oUgNimUd6Q]: hasVariant(
            $state,
            "type",
            "bordered"
          )
      ...
      >
        <div
          className={classNames("all", sty.freeBox__vzycw, {
            [sty.freeBoxcolor_neutral__vzycWmKXrd]: hasVariant(
              $state,
              "color",
              "neutral"
            ),
            [sty.freeBoxcolor_neutral_type_soft__vzycWmKXrdUiC61]:
              hasVariant($state, "color", "neutral") &&
              hasVariant($state, "type", "soft"),
            [sty.freeBoxiconStart__vzycw0Hibq]: hasVariant(
              $state,
              "iconStart",
              "iconStart"
            ),
            [sty.freeBoxsize_extraLarge__vzycWmIguE]: hasVariant(
              $state,
              "size",
              "extraLarge"
            ),
            [sty.freeBoxsize_large__vzycwf9TjD]: hasVariant(
              $state,
              "size",
              "large"
            ),
            [sty.freeBoxsize_small__vzycwHj19N]: hasVariant(
              $state,
              "size",
              "small"
            ),
            [sty.freeBoxtype_bordered__vzycWmUd6Q]: hasVariant(
              $state,
              "type",
              "bordered"
            )
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <CircleIcon
                className={classNames("all", sty.svg__ntMdg)}
                role={"img"}
              />
            ),
        ...
        {renderPlasmicSlot({
          defaultContents: (
            <div className={classNames("all", "__wab_text", sty.text__uoEee)}>
              {"Text"}
            </div>
          ),
        ...
        <div
          className={classNames("all", sty.freeBox__t2FwZ, {
            [sty.freeBoxiconEnd__t2FwZcRKtT]: hasVariant(
              $state,
              "iconEnd",
              "iconEnd"
            ),
            [sty.freeBoxsize_extraLarge__t2FwZmIguE]: hasVariant(
              $state,
              "size",
              "extraLarge"
            ),
            [sty.freeBoxsize_large__t2FwZf9TjD]: hasVariant(
              $state,
              "size",
              "large"
            ),
            [sty.freeBoxsize_small__t2FwZHj19N]: hasVariant(
              $state,
              "size",
              "small"
            )
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <ChevronDownIcon
                className={classNames("all", sty.svg__yMl7F)}
                role={"img"}
              />
            ),
